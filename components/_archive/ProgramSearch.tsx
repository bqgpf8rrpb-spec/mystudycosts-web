...
import ProgramCard, { type NCIndexEntry } from '../nc-checker/ProgramCard';
...
/**
 * @deprecated Archived - not imported anywhere. NCCheckerContent has its own search. Kept for reference.
 */
